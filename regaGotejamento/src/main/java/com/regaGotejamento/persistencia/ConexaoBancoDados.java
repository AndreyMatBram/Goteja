package com.regaGotejamento.persistencia;
...
public class ConexaoBancoDados {
	...
	private EntityManagerFactory getFactory() {
		...
		propriedades.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/regaGotejamento");
		...
		propriedades.put("characterEnconding", "UTF-8");
		propriedades.put("hibernate.default_schema", "projetoMicroEventos");
		// propriedades.put("", "");

		return Persistence.createEntityManagerFactory("regaGotejamento", propriedades);
	}
}